...
namespace TdLib
{
    ...
    public static partial class TdApi
    {
        ...
        /// </summary>
        public class GetUserGifts : Function<UserGifts>
        {
            /// <summary>
            /// Data type for serialization
            /// </summary>
            [JsonProperty("@type")]
            public override string DataType { get; set; } = "getUserGifts";
        ...
        /// Returns gifts saved to profile by the given user
        /// </summary>
        public static Task<UserGifts> GetUserGiftsAsync(
            this Client client, long userId = default, string offset = default, int limit = default)
        {
            return client.ExecuteAsync(new GetUserGifts
            {
